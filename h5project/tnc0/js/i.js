...
(function($) {
    ...
    $f = window.$f || {
        ...
        slideRender: function(tar, f, t, dur, flag, c, dir) {
            ...
            $tar.eq(f).stop(true, false).trigger("slideOut").css({
                "display": "block",
                "z-index": 0
            }).animate(f_end, dur + 50, "easeOutSine", function() {
                $(this).hide();
        ...
        cssInit: function() {
            ...
            _.ns = $(".bscroll").niceScroll({
                autohidemode: false,
                cursorwidth: 6,
                cursorcolor: "#00713d" /*!$ie8?"rgba(0,0,0,0.75)":"#292929"*/
                ,
                cursorborder: "none",
            ...
            $(".mscroll").bind("mouseenter", function() {
                $(this).stop().animate({
                    width: 10,
                    marginLeft: -4
                }, 350);
            ...
            $(".bscroll").bind("scroll", function(e) {
                !_.animState && _.animateLoop(_.animState)
            });
        ...
        loadedhandle: function() {
            ...
            if (_hasNew && _newObj) {
                $("#nav_4").data("tip", ".nav_tip").data("tipfunc", function() {
                    $("#v0_news").remove();
                    $("#v0_tip").remove()
            ...
            if (_tad && _.isArray(_tad)) {
                ...
                for (var i = 0; i < _tad.length; i++) {
                    ...
                    (function(_i) {
                        img.onload = function() {
                            _ad.width = this.width, _ad.height = this.height;
        ...
        footLinkInit: function() {
            ...
            $(".foot_links").each(function(index, element) {
                ...
                $links.bind("mouseenter", function(e, f) {
                    ...
                    _CLICK[_id] = 1;
                    _.slideRender($par.parents(".view").find(".view_content"), f, t, $f.navCur != arrIndex[index] ? 0 : 750, _f, function() {
                        _CLICK[_id] = 0
                    });
            ...
            $('.view_content:not(".static")').each(function(index, e) {
                ...
                $btn.bind("click", function(e) {
                    ...
                    if (_dir + _cur >= 0 && _dir + _cur < _all) {
                        _CLICK.f = 1;
                        _.dirSlide($list.children(".view_ul"), _dir, function() {
                            _CLICK.f = 0
                        });
                        $btn.eq(0).css({
        ...
        featureInit: function() {
            var _ = this,
                $fea = $("#feature");
            $(".fea_ul a").bind("mouseenter", function() {
                $(this).stop().animate({
                    width: 120
            ...
            $(".feature").bind("show", function(e, ul) {
                _.animPause(1);
                $(".fea_mask").show();
                var css = {
                    left: "35%",
                ...
                !$ie8 && (css.opacity = 1);
                $(this).stop().show().animate(css, 750, "easeOutQuint", function() { !! ul && $(ul, this).stop().animate({
                    left: -10
                }, 500)
                }); !! ul && $(ul, this).css({
                    left: 150
                ...
                !$ie8 && (css.opacity = 0);
                $(this).stop().animate(css, 750, "easeOutQuint", function() {
                    $(this).hide();
                    $(".fea_mask").hide();
                    _.animPlay(1);
            ...
            $(".map_btn").bind("mouseenter", function() {
                var _this = $(this),
        ...
        navInit: function() {
            ...
            var _ = this,
                navTimer = null,
                navUpdate = function() {
                    $(".nav_li.current").addClass("hover");
                    !$ie8 && $(".nav_li.current").find(".nav_sub").stop().show().animate({
                        height: 124,
                        opacity: 1
            ...
            $(".nav_li").each(function(index, element) {
                ...
                $(this).bind("mouseenter", function(e, flag) {
                    $(this).find(".hover").css({
                        display: "block"
                    });
                    ...
                    if (!$(this).hasClass("current")) {
                        ...
                        !$ie8 && $sub.stop().show().animate({
                            height: _h,
                            opacity: 1
                        }, $sub.hasClass("toggle") ? 0 : 300, "easeOutQuint", function() {
                ...
                }).bind("mouseleave", function(e, flag) {
                    var $sub = $(".nav_sub", this),
                        $dl = $("dl", this),
                        $dd = $("dd", $dl);
                    $(this).find(".hover").css({
                ...
                $(".nav_sub dd a").bind("click", function() {
            ...
            $(".RNav li").bind("mouseenter", function() {
        ...
        navRender: function(_cur) {
            ...
            if (_.$ni.eq(_c).hasClass("nav_li")) {
                ...
                if ($$.data("tip")) {
                    var _tip = $$.data("tip"),
                        _func = $$.data("tipfunc");
                    $$.removeData("tip").find(_tip).fadeOut(1000, function() {
                        $(this).remove()
                    });
        ...
        animInit: function() {
            ...
            _.Aom = _new(_am, {
                ...
                }), staObj("logo", pos - 100, 520, function() {
                    $(this.elem).fadeOut(500)
                }, function() {
                    $(this.elem).fadeIn(500)
                }), pageObj("tncChina", pos, 1070, 255, 15, 255, ["t", "h"], [100, 75], [-50, 100], [0, 100]), elemObj("v1_text", pos + 120, 950, 195, 15, 255, ["t"], [90], [50], [50], true), elemObj("v1_links", pos + 150, 920, 180, 15, 255, ["t"], [150], [70], [70], true), staObj("tips", pos - 100, 210, function() {
                ...
                }), pageObj("tncWorld", pos += 540, 1490, 255, 225, 255, ["t", "h"], [100, 75], [-50, 100], [0, 100]), speObj("v2_text", pos + 120, 1370, ["t", "mt"], [195, 225, 255], [
                    [80, "-59px"],
                    [30, "-59px"],
                    [0, "-100px"],
                    [0, "-100px"]
                ]), speObj("tncWorld", pos + 510, 450, ["bY"], [450], [
                    ["0px"],
                    ["-450px"]
                ], true), speObj("v2_body", pos + 510, 450, ["t", "mt"], [200], [
                    [70, "0px"],
                    [50, "-213px"]
                ], true, 500), staObj("v2_point_1", pos + 510, 600, pointShow, pointHide), staObj("v2_point_2", pos + 560, 600, pointShow, pointHide), staObj("v2_point_3", pos + 610, 600, pointShow, pointHide), staObj("v2_point_4", pos + 660, 600, pointShow, pointHide), staObj("v2_point_5", pos + 710, 600, pointShow, pointHide), staObj("v2_point_6", pos + 760, 600, pointShow, pointHide), staObj("v2_point_7", pos + 810, 600, pointShow, pointHide), staObj("v2_point_8", pos + 860, 600, pointShow, pointHide), pageObj("tncEvent", pos += 960, 1970, 255, 465, 255, ["t", "h"], [100, 75], [-50, 100], [0, 100]), speObj("v3_text", pos + 120, 1550, ["t", "mt"], [195, 115, 455], [
                    [80, "-59px"],
                    [30, "-59px"],
                    [0, "-100px"],
                    [0, "-100px"]
                ], false, 300), speObj("v3_content", pos + 120, 1550, ["t", "mt"], [310, 455], [
                    [100, "-59px"],
                    [0, "150px"],
                    [0, "150px"]
                ], true, 300), speObj("tncEvent", pos + 510, 900, ["bY"], [300], [
                    ["0px"],
                    ["-450px"]
                ], true), speObj("v3_body", pos + 450, 1500, ["mt"], [510, 300], [
                    ["0px"],
                    ["-1300px"],
                    ["-1300px"]
                ], true), speObj("v3_mask", pos + 450, 1200, ["h"], [600], [
                    ["0px"],
                    ["2068px"]
                ], true, 300, {
                    oAnim: function(a, b) {
    ...
    (function() {
        ...
        $(".fea_btn,.map_btn").bind("click", function() { !! (_pro = _IFRAME[$(this).data("pro")]) && !! _pro["link"] && _tPage(_pro["link"])
        })
    })();
    var _TPL_0 = [{
        "url": "schedule",
