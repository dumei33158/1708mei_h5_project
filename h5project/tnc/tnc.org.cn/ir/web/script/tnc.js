...
$TNC={
	...
	renderElemData:function($obj,pos){
		...
		var mp3html='<div class="mp3cover" style="height:32px;padding:5px;cursor:pointer;"><img src="../img/icons/icon3.png"/*tpa=http://tnc.org.cn/ir/web/img/icons/icon3.png*/ /></div>';
		...
		var cover2='<div style="clear:both;height:0px;"></div><div style="position:absolute;width:28px;height:15px;left:50%;margin-left:-14px;bottom:-15px;"><img src="../img/icons/icon4.png"/*tpa=http://tnc.org.cn/ir/web/img/icons/icon4.png*/ /></div></div>';
		if(!!data.head){
			cover1+=('<div style="float:left;width:120px;margin-right:20px;"><img src="'+data.head+'" width="100%"/></div>');
		}
		if(!!data.audio){
			cover1+=('<div class="mp3cover" style="height:32px;padding:5px;cursor:pointer;"><img src="../img/icons/icon3.png"/*tpa=http://tnc.org.cn/ir/web/img/icons/icon3.png*/ />'+
			...
			if(!!audio){
				if($(this).hasClass("beplay")){
					if(typeof(audio.pause)=='function'){
						...
						$(this).find("img").attr("src",$(this).find("img").attr("src").replace(/icon7.png$/,"icon3.png"/*tpa=http://tnc.org.cn/ir/web/script/icon3.png*/));
					}
				}else{
					if(typeof(audio.play)=='function'){
						audio.play();
						$(this).addClass("beplay");
						$(this).find("img").attr("src",$(this).find("img").attr("src").replace(/icon3.png$/,"icon7.png"/*tpa=http://tnc.org.cn/ir/web/script/icon7.png*/));
					}
				}
			}
		});
